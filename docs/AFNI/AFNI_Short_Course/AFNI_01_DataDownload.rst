...
Rename the folder "Flanker" by either right-clicking on the directory and renaming it, or opening up a Terminal, navigating to to the Desktop, and typing the following:

::

    mv ds000102-00001 Flanker

After you have downloaded and unzipped the dataset and moved it to your Desktop, click on the Next button for an overview of the experimental task used in this study.
